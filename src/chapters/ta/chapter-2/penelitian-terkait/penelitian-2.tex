...
Penelitian yang dilakukan oleh \textciteyear{carta2024end} menunjukkan penggunaan model \donut{} untuk mengekstrak data dari dokumen identitas. Dokumen yang digunakan berupa kartu identitas elektronik, kartu identitas, surat izin mengemudi, dan kartu kesehatan. Evaluasi dilakukan dengan membandingkan model yang telah di-\textit{fine-tuned} dan model basis dengan menggunakan metrik \fscore, \mcerfull, dan \tedfull. 
...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{|X|C|C|C|C|C|C|}
        ...
        \multirow{2}{*}{Dokumen} & \multicolumn{3}{c|}{\textbf{Donut Base}} & \multicolumn{3}{c|}{\textbf{Donut Synth}} \\
        ...
        & \textbf{TED} & \textbf{F1} & \textbf{mCER} & \textbf{TED} & \textbf{F1} & \textbf{mCER} \\
