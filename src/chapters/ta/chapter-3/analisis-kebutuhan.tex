...
\hline
P-02 & Pengguna merasa kesulitan untuk mencatat pengeluaran secara manual dari berbagai bukti transaksi. Proses ini memakan waktu, rentan terhadap kesalahan input, dan sering kali tidak dilakukan secara konsisten. \\
\hline
P-03 & Pengguna merasa kesulitan untuk memetakan dan mengelompokkan informasi dari bukti pembayaran yang tidak terstruktur sehingga pengguna kesulitan untuk memasukkan data ke dalam \emph{platform} keuangan. \\
\hline
\end{tabularx}
\end{table}
% \begin{enumerate}
...
\hline
FR-03 & Sistem harus dapat mengekstrak dan memetakan informasi \newline kunci, yaitu total pembayaran, tipe transaksi, dan target dari bukti QRIS dan transfer. Informasi kunci yang perlu dipetakan dari struk adalah total pembayaran \\
\hline
