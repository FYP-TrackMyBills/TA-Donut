...
\hline
NF-07 & \emph{Performance} & Hasil evaluasi \accuracy{}, \precision, \recall, dan \fscore{} lebih besar daripada 70\%, \mcer{} lebih kecil dari 20\%, dan SUS Score lebih besar dari 68.  \\
\hline
\end{tabularx}
\end{table}