...
\hline
NF-01 & S-06 & Penguji mengevaluasi kemudahan penggunaan antarmuka (\emph{Usability}) dengan melakukan proses dari unggah, tinjau, hingga simpan. & Antarmuka pengguna (UI) harus minimalis dan intuitif, memungkinkan pengguna mengubah gambar bukti bayar menjadi data transaksi dalam beberapa langkah sederhana (unggah, tinjau, simpan). \\
\hline
\end{tabularx}
\end{table}
