...
\title{Pengembangan Sistem Ekstraksi Data dari Struk dan Bukti Pembayaran Berbasis \emph{Computer Vision} dan \emph{Deep Learning} Tanpa OCR untuk Pencatatan Pengeluaran}
\date{}
\author{
	\MakeUppercase{\namapenulis \\
		NIM: \nimpenulis}
